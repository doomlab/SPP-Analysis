...
summary(model.2a)
r.squaredGLMM(model.2a) #r2m = 0.002664677
...
summary(model.2b)
r.squaredGLMM(model.2b) #r2m = 0.002702195
...
summary(model.2c)
r.squaredGLMM(model.2c) #r2m = 0.002711783
...
summary(model.2.2a)
r.squaredGLMM(model.2.2a) #r2m = 0.00286622
...
summary(model.3a.a)
r.squaredGLMM(model.3a.a) #r2m = 0.002898865
...
summary(model.3a.b)
r.squaredGLMM(model.3a.b) #r2m = 0.002997564
...
summary(model.3a.c)
r.squaredGLMM(model.3a.c) #r2m = 0.003002183
...
r.squaredGLMM(model.3.2a.a) #r2m = 0.003042985
...
summary(model.4a.a)
r.squaredGLMM(model.4a.a) #r2m = 0.003208663
